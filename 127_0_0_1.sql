...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 24 2019 г., 10:14
...
-- База данных: `fbdb`
--
CREATE DATABASE IF NOT EXISTS `fbdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `fbdb`;
...
('m000000_000000_base', 1574495314),
('m191123_174727_create_user_table', 1574531437);
...
-- База данных: `fraqdb`
--
CREATE DATABASE IF NOT EXISTS `fraqdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `fraqdb`;
--
-- База данных: `messengerdb`
--
CREATE DATABASE IF NOT EXISTS `messengerdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `messengerdb`;
...
--
CREATE DATABASE IF NOT EXISTS `school2018mindb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `school2018mindb`;
...
--
CREATE DATABASE IF NOT EXISTS `testerdb2` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `testerdb2`;
...
--
CREATE DATABASE IF NOT EXISTS `testnetdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `testnetdb`;
...
('m181003_052530_create_music_table', 1563000596),
('m181003_052623_create_usermusic_table', 1563000597);
...
INSERT INTO `music` (`id`, `link`, `info`) VALUES
(1, '1563001023.mp3', 'бачата - латино'),
(2, '1563001447.mp3', 'Юлия Михальчик - Косы (album version)'),
(3, '1563001519.mp3', 'Михаил Яцевич - Баня');
...
(6, 'wal123', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL);
...
(2, 6, 'Валерий', 'Владимирович', 'Жданов', 'Пенза');

-- --------------------------------------------------------

--
-- Структура таблицы `usermusic`
--
...
--
-- Дамп данных таблицы `usermusic`
--

INSERT INTO `usermusic` (`id`, `user_id`, `music_id`) VALUES
(1, 1, 1),
(2, 6, 2),
(3, 6, 3);
...
--
-- AUTO_INCREMENT для таблицы `usermusic`
--
ALTER TABLE `usermusic`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
